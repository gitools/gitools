...
/**
 * An overlay for marking pixels of the image. A circle will be drawn around the selected pixels; the size of the circle
 * is set independently of the current zoom, but it may be enlarged in order to contain the pixel entirely.
 * <p/>
 * The default size is 5 pixels and the default color is red.
 * <p/>
 * This object stores the list of pixels; this list can be edited with the {@link #setPoint(java.awt.Point)},
 * {@link #setPoints(Iterable)}, {@link #addPoint(java.awt.Point)}, and {@link #clear()} functions. All of these
...
public final class PixelMarkerOverlay extends Overlay {
    ...
    /**
     * Sets the size of the circle. The actual width and height of the circle will be {@code 2*newSize+1}.
     *
     * @param newSize the new size of the marker circles
