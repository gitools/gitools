...
import org.gitools.persistence.formats.geneset.GeneSetFormat;
import org.gitools.persistence.formats.matrix.*;
import org.gitools.persistence.formats.modulemap.IxmModuleMapFormat;
...
public class PersistenceInitialization {
    ...
    private static void registerFormats(PersistenceManager pm) {
