...
public abstract class MatrixTextPersistence<R extends BaseMatrix> extends BaseMatrixPersistence<R> {
    ...
    public R read(IResourceLocator resourceLocator, ValueTranslator valueTranslator, IProgressMonitor progressMonitor) throws PersistenceException {

        progressMonitor.begin("Loading matrix...", 1);
        progressMonitor.info("From: " + resourceLocator.getURL());

        R matrix = createEntity();
    ...
    public void readMetadata(IResourceLocator resourceLocator, R matrix, IProgressMonitor progressMonitor) throws PersistenceException {
    ...
    public void readData(IResourceLocator resourceLocator, R matrix, ValueTranslator valueTranslator, int[] columnsOrder, int[] rowsOrder, IProgressMonitor progressMonitor) throws PersistenceException {
    ...
    public void write(IResourceLocator resourceLocator, R matrix, ValueTranslator valueTranslator, IProgressMonitor monitor) throws PersistenceException {
