...
public class AnnotationMatrixTextPersistence extends AbstractResourcePersistence<AnnotationMatrix> {

    @Override
    public AnnotationMatrix read(IResourceLocator resource, IProgressMonitor monitor) throws PersistenceException {
