...
@ApplicationScoped
public class OverlappingAnalysisEditorCreator implements IEditorCreator{

    @Override
    public boolean canCreate(Object object) {
        return object instanceof OverlappingAnalysis;
    }

    @Override
    public IEditor create(Object object) {
        if (canCreate(object)) {
            return new OverlappingAnalysisEditor((OverlappingAnalysis) object);
        }
        return null;
    }
}
