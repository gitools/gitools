...
@ApplicationScoped
public class EnrichmentAnalysisEditorCreator implements IEditorCreator{

    @Override
    public boolean canCreate(Object object) {
        return object instanceof EnrichmentAnalysis;
    }

    @Override
    public IEditor create(Object object) {
        if (canCreate(object)) {
            return new EnrichmentAnalysisEditor((EnrichmentAnalysis) object);
        }
        return null;
    }
}
