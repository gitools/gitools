...
public class NewCombinationAnalysisAction extends BaseAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        IResourceFormat columnSetsFormat = ApplicationContext.getPersistenceManager().getFormat(columnSetsMime, IModuleMap.class);
        IResourceFormat dataFormat = ApplicationContext.getPersistenceManager().getFormat(wizard.getDataFilePage().getFileFormat().getExtension(), IMatrix.class);
