...
public class HeatmapPropertiesLabelsHeaderPanel extends HeatmapPropertiesAbstractPanel {
    ...
    public HeatmapPropertiesLabelsHeaderPanel(boolean rowMode) {
	...
	private void attributePatternBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attributePatternBtnActionPerformed
		...
		if (dlg.getReturnStatus() == ListDialog.RET_OK) {
			...
			try {
				...
				Logger.getLogger(HeatmapPropertiesLabelsHeaderPanel.class.getName()).log(Level.SEVERE, null, ex);
			}
		}
