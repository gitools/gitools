...
public class HeadersEditPanel extends JDialog
{
    ...
    private class HeadersTableModel extends AbstractTableAdapter<HeatmapHeader> implements Reorderable
    {
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex)
        {
            ...
            {
                case 1:
                    header.setTitle((String) aValue); break;
                case 2:
                    header.setSize((Integer) aValue); break;
                case 3:
                    header.setLabelColor((Color) aValue); break;
                case 4:
                    header.setBackgroundColor((Color) aValue); break;
                case 5:
                    header.setVisible((Boolean) aValue); break;
            }
