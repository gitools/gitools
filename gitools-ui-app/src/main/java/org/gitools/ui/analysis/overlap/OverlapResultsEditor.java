...
public class OverlapResultsEditor extends HeatmapEditor {
	...
	public OverlapResultsEditor(OverlappingAnalysis analysis) {
		super(createHeatmap(analysis), createToolBar(analysis), true);

		tablesPanel = new OverlapTablesPanel(analysis, heatmap);
