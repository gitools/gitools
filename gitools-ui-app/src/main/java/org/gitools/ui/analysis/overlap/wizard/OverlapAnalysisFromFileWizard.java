...
public class OverlapAnalysisFromFileWizard extends AbstractWizard {
	...
	protected OverlapFromFilePage corrPage;
	private SaveFilePage saveFilePage;
	protected AnalysisDetailsPage analysisDetailsPage;

	public OverlapAnalysisFromFileWizard() {
		super();
	...
	public void addPages() {
		...
		// Correlation method
		corrPage = new OverlapFromFilePage();
		addPage(corrPage);
