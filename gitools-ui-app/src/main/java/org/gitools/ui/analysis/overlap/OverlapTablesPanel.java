...
public class OverlapTablesPanel extends AbstractTablesPanel<OverlappingAnalysis> {

	private static Logger log = LoggerFactory.getLogger(OverlapTablesPanel.class);
	...
	public OverlapTablesPanel(OverlappingAnalysis analysis, Heatmap heatmap) {
