...
public class JobProgressMonitor extends StreamProgressMonitor {
    ...
    private final JobProgressGlassPane dlg;

    private static int TOTAL_WORK = 1000;

    private double correction;

    public JobProgressMonitor(JobProgressGlassPane dlg, PrintStream out, boolean verbose, boolean debug) {
        super(out, verbose, debug);

        this.dlg = dlg;
    }

    private JobProgressMonitor(IProgressMonitor parentMonitor, JobProgressGlassPane dlg, PrintStream out, boolean verbose, boolean debug) {
