...
public class RemoveMutualExclusiveAction extends HeatmapAction implements IMutualExclusiveAction {

    MutualExclusiveBookmark bookmark;

    public RemoveMutualExclusiveAction() {
        super("<html><i>Remove</i> result</html>");
    }
