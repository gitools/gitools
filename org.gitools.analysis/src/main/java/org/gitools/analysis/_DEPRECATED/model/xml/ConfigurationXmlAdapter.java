 ...
 * #L%
 */
package org.gitools.analysis._DEPRECATED.model.xml;
...
public class ConfigurationXmlAdapter extends XmlAdapter<ConfigurationXmlElement, Map<String, String>> {
    ...
    public ConfigurationXmlElement marshal(Map<String, String> v) throws Exception {
        ...
        List<ConfigurationXmlElement.ConfigurationXmlEntry> conf = e.getConfiguration();
        for (Map.Entry<String, String> entry : v.entrySet())
            conf.add(new ConfigurationXmlElement.ConfigurationXmlEntry(entry.getKey(), entry.getValue()));
        return e;
    }
}
