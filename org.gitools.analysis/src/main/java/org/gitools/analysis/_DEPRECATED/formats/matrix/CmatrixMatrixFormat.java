 ...
 * #L%
 */
package org.gitools.analysis._DEPRECATED.formats.matrix;

import org.apache.commons.io.IOUtils;
import org.gitools.analysis._DEPRECATED.formats.AbstractResourceFormat;
import org.gitools.analysis._DEPRECATED.matrix.model.compressmatrix.AbstractCompressor;
import org.gitools.analysis._DEPRECATED.matrix.model.compressmatrix.CompressDimension;
import org.gitools.analysis._DEPRECATED.matrix.model.compressmatrix.CompressMatrix;
...
public class CmatrixMatrixFormat extends AbstractResourceFormat<IMatrix> {
    ...
    protected CompressMatrix readResource(IResourceLocator resourceLocator, IProgressMonitor progressMonitor) throws PersistenceException {
        ...
        try {
            ...
            CompressDimension rowDim = new CompressDimension(MatrixDimensionKey.ROWS, rows);
            CompressDimension colDim = new CompressDimension(MatrixDimensionKey.COLUMNS, columns);
