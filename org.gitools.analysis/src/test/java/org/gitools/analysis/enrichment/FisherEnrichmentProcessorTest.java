...
public class FisherEnrichmentProcessorTest extends AbstractProcessorTest<EnrichmentAnalysis> {

    public FisherEnrichmentProcessorTest() {
        super(EnrichmentAnalysis.class, "/enrichment/test03.enrichment");
    }
