...
public class TsvTableWriter implements SequentialTableWriter {
	...
	public TsvTableWriter(File file, boolean compresssionEnabled) {
		this.file = file;
	...
	@Override
	public void write(String[] rowFields) {
