...
public class BiomartGenericSoapService implements BiomartSoapService {

	private static Logger log = Logger.getLogger(BiomartGenericSoapService.class.getName());
	...
	public BiomartGenericSoapService(BiomartSource bs) throws BiomartServiceException {
		try {
			bSource = bs;
	...
	/** 
	 * Return internal configuration (xml) of a dataset
	 * @param d
	 * @return
	 * @throws MalformedURLException
	 * @throws IOException
	 */
	private InputStream getDatasetConfigIS(DatasetInfo d) throws MalformedURLException, IOException {
