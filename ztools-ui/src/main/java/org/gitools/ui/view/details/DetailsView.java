...
import org.gitools.ui.view.details.heatmap.HeatmapDetailsController;

public class DetailsView extends AbstractView {

	private JScrollPane scrollPane;

	private Map<Class<?>, DetailsController> ctrlMap;

	public DetailsView() {
		ctrlMap = new HashMap<Class<?>, DetailsController>();
	...
	public void update(Object context) {
		DetailsController controller = ctrlMap.get(context.getClass());
		if (controller == null) {
